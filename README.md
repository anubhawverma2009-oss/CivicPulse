...
![Status](https://img.shields.io/badge/Status-Hackathon%20MVP-brightgreen?style=for-the-badge)
...
![Google AI](https://img.shields.io/badge/Powered%20by-Google%20AI-4285F4?style=for-the-badge)
🚀 Live Demo • 📖 Documentation • 🐞 Report Issue • ⭐ GitHub
...
If 2FA enabled: complete verification
Click "Allow" when app requests permissions
Step 3: Complete Onboarding (First Login Only)
Select role: "Citizen" (full feature access)
Select locality: Kanpur, Varanasi, Lucknow, Prayagraj, etc.
Click "Enter CivicPulse"
...
AI auto-fills: Category, Severity Score (1-10), Professional Description
...
Community Action:
See new issue in feed with AI description
Review severity score and photo
Vote: "✅ Yes, it's there" (confirms) or "❌ No, it's fixed" (resolved)
...
Authority Workflow:
Receives notification of high-priority issue
Assigns repair crew
Updates status: "In Progress"
Completes repair
Uploads resolution proof photo
Updates status: "Awaiting Verification"
Community Re-Verification:
Original voters receive notification
Vote: "✅ Problem solved" or "⏳ Still pending"
80%+ "Solved" = Auto-mark "Resolved"
Issue becomes permanent "Landmark" (community achievement)
---
...
```
Edit `.env.local` and add your credentials (see Environment Variables)
...
---
⚠️ Known Limitations
Image Analysis Accuracy: Classification quality depends on photo lighting and clarity. Lower-confidence results are flagged for manual review rather than auto-accepted.
Geographic Precision: Location accuracy depends on device GPS and connectivity, and may be reduced in rural or low-signal areas.
Language Support: Currently supports English and basic Hindi. Additional Indian languages are planned for the future roadmap.
Authority Integration: Authorities currently receive in-app notifications; direct integration with official municipal systems is planned for a future phase.
Proof Verification: Resolution proof is currently verified through community voting rather than automated fraud detection.
Scalability: The current build has been validated for demo and moderate-load scenarios; large-scale, real-world stress testing has not yet been performed.
Mobile Performance: On lower-end devices or slow mobile networks, image upload may take longer. A stable WiFi or 4G connection is recommended.
Browser Support: Best experienced on Chrome/Firefox. Older Safari versions may show minor UI inconsistencies.
---
📄 License
